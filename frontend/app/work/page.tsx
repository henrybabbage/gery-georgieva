...
const shellClass = 'mx-auto w-full max-w-[1260px] lg:px-[30px]'
  ...
  return (
    <div className="px-5 py-6">
      <div className={`${shellClass} text-left`}>
        {list.length === 0 ? (
          <p className="text-base opacity-40">No exhibitions yet.</p>
        ) : (
                ...
                >
                  {lead ? (
                    ...
                    <div className="flex aspect-[4/3] w-full items-end bg-placeholder p-3">
                      <span className="text-sm text-[var(--color-muted)]">{ex.title}</span>
                    </div>
                  )}
