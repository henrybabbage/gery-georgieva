 ...
 *
 * The pure layout rhythm/spans/spacing primitives live in `@/app/components/staggeredLayout`
 * so the Work index page can reuse the identical arrangement.
 */
...
function getExpandableImageProps(
  ...
  return {
    ...
    portraitMaxClass: orientation === 'portrait' ? PORTRAIT_MAX[tier] : '',
  }
}
